...
import { ROUTER_SUBTYPES } from '../../routers/router.constants';
import { SWITCH_SUBTYPES } from '../../routers/switch.constants';
import {
  OLT_SUBTYPES,
...
export class UpdateDeviceConnectionDto {
  ...
  /** Puerto de salida a Internet (nombre físico RouterOS). Vacío = limpiar. */
  @IsOptional()
  @ValidateIf((_, v) => v !== null && v !== '')
  @IsString()
  @MaxLength(80)
  ...
  /** VLAN sobre ese puerto; null/omitido = sin VLAN (interfaz física). */
  @IsOptional()
  @ValidateIf((_, v) => v !== null && v !== '')
  @Type(() => Number)
  @IsInt()
