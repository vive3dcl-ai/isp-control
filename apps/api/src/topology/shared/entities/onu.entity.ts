...
export class Onu {
  ...
  /**
   * Bindings OMCI eth_0/N → VLAN (IPTV untagged). Keys = port index as string.
   * Usado por Ajustes → TV para listar ONUs ligadas a cada VLAN TV.
   */
  @Column({
    name: 'eth_omci_vlans',
    type: 'jsonb',
  ...
  ethOmciVlans: Record<string, number>;
