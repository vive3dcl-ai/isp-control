...
/**
 * Países del desplegable en Empresa (monedas soportadas + ES, US, CA).
 */
...
export type CompanyProfile = {
  ...
  /** Logo del portal; vacío = usa el logo de empresa */
  suspensionPortalLogoUrl: string
  suspensionPortalMode: 'internal' | 'external'
  suspensionPortalExternalUrl: string
  /** URL efectiva (interna o externa) usada para MikroTik / clientes */
  suspensionPortalUrl: string
